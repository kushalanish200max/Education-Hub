...
export default function StudyDashboard() {
  return (
    // Base layout: using specific hex codes to match the image's deep navy aesthetic
    <div className="min-h-screen bg-[#0B0F19] text-slate-200 font-sans flex items-center justify-center">
      ...
      <div className="flex w-screen h-screen bg-[#121624]  overflow-hidden shadow-2xl border border-white/5">
        ...
        <aside className="w-64 bg-[#161B2B] p-6 flex flex-col border-r border-white/5">
          ...
          {/* Quote Box */}
          <div className="bg-[#1A1F2C] p-5 rounded-2xl border border-white/5">
            <p className="text-xs text-slate-400 font-medium">
              <span className="text-2xl text-purple-500 font-serif leading-none mr-3">
                "
              </span>
              Discipline today
            </p>
            <p className="text-xs text-slate-400 font-medium">
              <span className="ml-5">freedom tomorrow.</span>
              <span className="text-2xl text-purple-500 font-serif leading-none ml-2">
                "
              </span>
            </p>
          </div>
        ...
        >
          ...
          <div className="grid grid-cols-[2fr_1fr] gap-6">
            ...
            <div className="bg-[#1A1F2C] rounded-3xl p-6 border border-white/5 relative">
              ...
              {/* Bottom Quote inside Chart panel */}
            ...
            <div className="bg-[#1A1F2C] rounded-3xl p-6 border border-white/5 flex flex-col items-center justify-between">
              ...
              {/* Custom CSS Circular Progress implementation */}
